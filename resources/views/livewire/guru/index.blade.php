<div class="p-5 space-y-5 bg-gradient-to-b from-blue-300 to-blue-400 rounded-xl shadow-md text-white">
    <div class="border border-blue-700 rounded-xl bg-white shadow-inner overflow-hidden">
        <div class="guru-container h-[calc(100vh-200px)] flex flex-col">
            {{-- Pastikan ini ditempatkan dalam container yang tidak punya padding/margin atas --}}
            <div class="w-full">
                {{-- Header --}}
